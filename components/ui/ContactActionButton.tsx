...
export default function ContactActionButton({
  ...
  return (
    <button type={type} className={commonClass}>
      {icon}
      {children}
    </button>
  );
